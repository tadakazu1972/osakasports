function drawSearch(){
  ...
  setOption(1, 31, 'datefromDate', this_date);
  setOption(1, 12, 'datetoMonth', this_month);
  setOption(1, 31, 'datetoDate', this_date);
...
function clickSearch(){
  ...
  fromDate  = encodeURIComponent(document.getElementById("datefromDate").value);
  toMonth   = encodeURIComponent(document.getElementById("datetoMonth").value);
  toDate    = encodeURIComponent(document.getElementById("datetoDate").value);
